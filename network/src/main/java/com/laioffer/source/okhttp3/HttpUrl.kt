...
import com.laioffer.source.okhttp3.internal.canParseAsIpAddress
import com.laioffer.source.okhttp3.internal.delimiterOffset
import com.laioffer.source.okhttp3.internal.indexOfFirstNonAsciiWhitespace
import com.laioffer.source.okhttp3.internal.indexOfLastNonAsciiWhitespace
import com.laioffer.source.okhttp3.internal.parseHexDigit
import com.laioffer.source.okhttp3.internal.publicsuffix.PublicSuffixDatabase
import com.laioffer.source.okhttp3.internal.toCanonicalHost
import com.laioffer.source.okhttp3.HttpUrl.Companion.toHttpUrl
import com.laioffer.source.okhttp3.HttpUrl.Companion.toHttpUrlOrNull
import okio.Buffer
  ...
  companion object {
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith(
            ...
            imports = ["com.laioffer.source.okhttp3.HttpUrl.Companion.toHttpUrl"]),
        level = DeprecationLevel.ERROR)
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith(
            ...
            imports = ["com.laioffer.source.okhttp3.HttpUrl.Companion.toHttpUrlOrNull"]),
        level = DeprecationLevel.ERROR)
