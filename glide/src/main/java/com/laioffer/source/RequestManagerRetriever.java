...
import com.laioffer.source.binding.ApplicationLifecycle;
import com.laioffer.source.util.Util;

/**
 * 类描述:
 * <p>
 * created by 西伯利亚哈士奇 on 2024/6/10 17:10
 */
public class RequestManagerRetriever {
  ...
  public RequestManager get(@NonNull Context context) {
    if (context == null) {
      throw new IllegalArgumentException("你传入的是空的 context ... ");
    ...
    // 若上面的判断都不满足，就会执行下面这句代码，Application 作用域（红色区域）
